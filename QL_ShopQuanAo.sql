...
--ÁO
--trễ vai
EXEC sp_AddSP N'Floral Off-The-Shoulder Top',40,'L',650000,'1.jpn',N'Việt Nam','LSP01'
EXEC sp_AddSP N'Tie Dye Long Sleeve Cover Up Top',40,'M',280000,'2.jpn',N'Trung Quốc','LSP01'
EXEC sp_AddSP N'Floral Mesh Bell Sleeve Crop Top',40,'S',460000,'3.jpn',N'Hàn Quốc','LSP01'
EXEC sp_AddSP N'Off-Shoulder Ruffle Shirt',40,'XL',550000,'4.jpn',N'Thái Lan','LSP01'
EXEC sp_AddSP N'Solid Twist Front Crop Top',40,'M',280000,'5.jpn',N'Việt Nam','LSP01'

--áo croptop

EXEC sp_AddSP N'Boho Tie Front Embroidered Top',40,'L',650000,'6.jpn',N'Việt Nam','LSP02'
EXEC sp_AddSP N'Short Sleeve Denim Crop Shirt',40,'M',740000,'7.jpn',N'Mỹ','LSP02'
EXEC sp_AddSP N'V-Neck Baby Tee',40,'M',320000,'8.jpn',N'Nhật','LSP02'
EXEC sp_AddSP N'Letter Print Crop Polo',40,'XL',450000,'9.jpn',N'Hàn Quốc','LSP02'
EXEC sp_AddSP N'Demin Button Up Crop Top',40,'S',650000,'10.jpn',N'Thái Lan','LSP02'
--áo sơ mi

EXEC sp_AddSP N'Glitter Tie Front',40,'XL',400000,'11.jpn',N'Việt Nam','LSP03'
EXEC sp_AddSP N'Stripe Button Up Blouse',40,'L',550000,'12.jpn',N'Trung Quốc','LSP03'
EXEC sp_AddSP N'Solid Long Sleeve Crop Blouse',40,'S',290000,'13.jpn',N'Hàn Quốc','LSP03'
EXEC sp_AddSP N'Solid Waist Tied Button Up Blous',40,'M',620000,'14.jpn',N'Nhật Bản','LSP03'
EXEC sp_AddSP N'Denim Button Up Crop Shirt',40,'L',500000,'15.jpn',N'Việt Nam','LSP03'
--hai dây
EXEC sp_AddSP N'Colorful Stripe Bow Shirred Tank Top',40,'L',440000,'16.jpn',N'Hàn Quốc','LSP04'
EXEC sp_AddSP N'Glitter Tie Front Tank Top',40,'XL',590000,'17.jpn',N'Việt Nam','LSP04'
EXEC sp_AddSP N'Demin Button Up',40,'M',780000,'18.jpn',N'Mỹ','LSP04'
EXEC sp_AddSP N'Solid Ruffle Hem V-Neck Cami Top',40,'XL',430000,'19.jpn',N'Việt Nam','LSP04'
EXEC sp_AddSP N'Solid Cross Rib',40,'S',390000,'20.jpn',N'Anh','LSP04'

--QUẦN
--quần short
EXEC sp_AddSP N'Colorblock Mid Rise Shorts',40,'XL',560000,'21.jpn',N'Nhật','LSP05'
EXEC sp_AddSP N'Wave Stripe Detail Shorts',40,'XL',650000,'22.jpn',N'Việt Nam','LSP05'
EXEC sp_AddSP N'Solid Denim Ripped Shorts',40,'S',340000,'23.jpn',N'Thái Lan','LSP05'
EXEC sp_AddSP N'Embroidered Floral Denim Mini Shorts',40,'L',660000,'24.jpn',N'Việt Nam','LSP05'
EXEC sp_AddSP N'Solid Bowknot Mini Shorts',40,'S',230000,'25.jpn',N'Hàn Quốc','LSP05'
--quần ống loe
EXEC sp_AddSP N'Retro All Over Print Knit Pants',40,'XL',550000,'26.jpn',N'Trung Quốc','LSP06'
EXEC sp_AddSP N'Blue Cable Knit Trousers',40,'M',720000,'27.jpn',N'Hàn Quốc','LSP06'
EXEC sp_AddSP N'Bow Slit High Waist Knit Flares',40,'M',190000,'28.jpn',N'Anh','LSP06'
EXEC sp_AddSP N'Houndstooth Wide Leg Knit Trousers',40,'S',450000,'29.jpn',N'Việt Nam','LSP06'
EXEC sp_AddSP N'Contrast Color Knit Trousers',40,'XL',490000,'30.jpn',N'Mỹ','LSP06'
--quần skinny
EXEC sp_AddSP N'Decipher Me Knitted Trousers',40,'L',170000,'31.jpn',N'Nhật','LSP07'
EXEC sp_AddSP N'Embroidery Flare Leg Jeans',40,'L',340000,'32.jpn',N'Hàn Quốc','LSP07'
EXEC sp_AddSP N'Solid Pocket Cargo Pants',40,'S',640000,'33.jpn',N'Việt Nam','LSP07'
EXEC sp_AddSP N'First Bloom Wide Leg Trousers',40,'XL',760000,'34.jpn',N'Thái Lan','LSP07'
EXEC sp_AddSP N'Strawberry Fields Wide Leg Trousers',40,'S',380000,'35.jpn',N'Mỹ','LSP07'
--quẩn giả váy
EXEC sp_AddSP N'Solid Mini Pleated Skirt With Belt','L',40,240000,'36.jpn',N'Hàn Quốc','LSP08'
EXEC sp_AddSP N'Retro Floral Mini Shorts','L',40,430000,'37.jpn',N'Nhật','LSP08'
EXEC sp_AddSP N'Knit Mini Pleated Skirt','M',40,360000,'38.jpn',N'Thái Lan','LSP08'
EXEC sp_AddSP N'Solid Mini Pleated Shorts','XL',40,530000,'39.jpn',N'Việt Nam','LSP08'
EXEC sp_AddSP N'Solid Bow Shorts','S',40,250000,'40.jpn',N'Hàn Quốc','LSP08'

--VÁY
--váy bút tennis
EXEC sp_AddSP N'Floral Print Mini Ruffle Skirt',40,'S',530000,'41.jpn',N'Việt Nam','LSP09'
EXEC sp_AddSP N'Hazelnut Latte Micro Mini Skirt',40,'XL',240000,'42.jpn',N'Việt Nam','LSP09'
EXEC sp_AddSP N'Little Bit Angelic White Mini Skirt',40,'S',260000,'43.jpn',N'Nhật','LSP09'
EXEC sp_AddSP N'Solid Ruffle Skort',40,'M',240000,'44.jpn',N'Mỹ','LSP09'
EXEC sp_AddSP N'Hot Summer Y2K Mini Skirt',40,'L',320000,'45.jpn',N'Thái Lan','LSP09'
--váy chữ A
EXEC sp_AddSP N'Double Button Mini Skort',40,'L',360000,'46.jpn',N'Việt Nam','LSP10'
EXEC sp_AddSP N'Solid Side Pocket Mini Skirt',40,'M',420000,'47.jpn',N'Hàn Quốc','LSP10'
EXEC sp_AddSP N'Toile de Jouy Mini Skirt',40,'S',330000,'48.jpn',N'Việt Nam','LSP10'
EXEC sp_AddSP N'Curve & Plus Paisley Pattern Slit Lo',40,'XL',660000,'49.jpn',N'Hàn Quốc','LSP10'
EXEC sp_AddSP N'Solid Mini Skirt With Belt',40,'M',200000,'50.jpn',N'Thái Lan','LSP10'
--váy jeans
EXEC sp_AddSP N'Denim Pocket Mini Skirt',40,'L',240000,'51.jpn',N'Việt Nam','LSP11'
EXEC sp_AddSP N'Butterfly Print Mini Denim Skirt',40,'L',440000,'52.jpn',N'Việt Nam','LSP11'
EXEC sp_AddSP N'Solid Pleated Mini Skirt',40,'XL',540000,'53.jpn',N'Thái Lan','LSP11'
EXEC sp_AddSP N'Solid Texture Mini Skort',40,'S',250000,'54.jpn',N'Nhật','LSP11'
EXEC sp_AddSP N'Butterfly Print Mini Denim Skirt',40,'XL',540000,'55.jpn',N'Việt Nam','LSP11'
--váy xòe
EXEC sp_AddSP N'Solid Pleated Mini Skirt',40,'L',430000,'56.jpn',N'Mỹ','LSP12'
EXEC sp_AddSP N'Vertical Stripe Pleated Mini Skirt',40,'M',370000,'57.jpn',N'Thái Lan','LSP12'
EXEC sp_AddSP N'Solid Flap Pocket Cargo Skirt',40,'XL',360000,'58.jpn',N'Hàn Quốc','LSP12'
EXEC sp_AddSP N'Denim Mini Low Rise Pleated Skort',40,'S',370000,'59.jpn',N'Việt Nam','LSP12'
EXEC sp_AddSP N'Solid Ruffle Hem Mini Skirt',40,'XL',270000,'60.jpn',N'Việt Nam','LSP12'

--ĐẦM
--BODY
EXEC sp_AddSP N'Solid Ruched Mini Dress',40,'L',760000,'61.jpn',N'Mỹ','LSP13'
EXEC sp_AddSP N'Contrasting Edge Pearl Knit Dress',40,'S',650000,'62.jpn',N'Hàn Quốc','LSP13'
EXEC sp_AddSP N'Solid Satin Slit Midi Dress',40,'M',750000,'63.jpn',N'Nhật','LSP13'
EXEC sp_AddSP N'Asymmetric Neck Mini Halter Dress',40,'M',750000,'64.jpn',N'Nhật','LSP13'
EXEC sp_AddSP N'Đầm body 5',40,'S',460000,'65.jpn',N'Việt Nam','LSP13'

--baby doll
EXEC sp_AddSP N'Geometric Pattern Zipped Mini Dress',40,'XL',750000,'66.jpn',N'Thái Lan','LSP14'
EXEC sp_AddSP N'Floral Slit Knotted Midi Dress',40,'M',360000,'67.jpn',N'Mỹ','LSP14'
EXEC sp_AddSP N'Floral Slit Cami Midi Dress',40,'L',360000,'68.jpn',N'Hàn Quốc','LSP14'
EXEC sp_AddSP N'Floral Puff Sleeve Mini Dress',40,'S',220000,'69.jpn',N'Việt Nam','LSP14'
EXEC sp_AddSP N'Blossom Floral Mini Dress',40,'M',730000,'70.jpn',N'Trung Quốc','LSP14'

--đầm trễ vai
EXEC sp_AddSP N'Floral Bell Sleeve Corset Mini Dress',40,'L',360000,'71.jpn',N'Hàn Quốc','LSP15'
EXEC sp_AddSP N'Off Shoulder Corset Mini Dress',40,'S',740000,'72.jpn',N'Nhật','LSP15'
EXEC sp_AddSP N'Illusion Tie Dye Ruched Maxi Dress',40,'XL',460000,'73.jpn',N'Thái Lan','LSP15'
EXEC sp_AddSP N'Curve & Plus Floral Ruffle Halter Mini Dress',40,'S',340000,'74.jpn',N'Hàn Quốc','LSP15'
EXEC sp_AddSP N'Tie Dye Off-Shoulder Mini Dress',40,'L',230000,'75.jpn',N'Mỹ','LSP15'
--set
EXEC sp_AddSP N'Illusion Floral Knotted Maxi Dress',40,'XL',600000,'76.jpn',N'Việt Nam','LSP16'
EXEC sp_AddSP N'Solid V-Neckline Cami Dress',40,'M',750000,'77.jpn',N'Trung Quốc','LSP16'
EXEC sp_AddSP N'Watercolor Floral Backless Maxi Dress',40,'M',540000,'78.jpn',N'Hàn Quốc','LSP16'
EXEC sp_AddSP N'Satin Off-Shoulder Maxi Dress',40,'L',350000,'79.jpn',N'Mỹ','LSP16'
EXEC sp_AddSP N'Colorblock Rib Knit Midi Dress',40,'S',460000,'80.jpn',N'Việt Nam','LSP16'

--Phụ kiện
--mũ
EXEC sp_AddSP N'Solid Bucket Hat',40,'M',570000,'81.jpn',N'Thái Lan','LSP17'
EXEC sp_AddSP N'Letter C Baker Boy Hat',40,'S',240000,'82.jpn',N'Trung Quốc','LSP17'
EXEC sp_AddSP N'Flower Decor Straw hat',40,'XL',230000,'83.jpn',N'Việt Nam','LSP17'
EXEC sp_AddSP N'Heart Knit Hat',40,'L',350000,'84.jpn',N'Hàn Quốc','LSP17'
EXEC sp_AddSP N'Letter Bucket Hat',40,'S',250000,'85.jpn',N'Mỹ'
--túi

EXEC sp_AddSP N'Túi trái tim',40,'S',760000,'86.jpn',N'Hàn Quốc','LSP18'
EXEC sp_AddSP N'Túi nơ',40,'M',780000,'87.jpn',N'Mỹ','LSP18'
EXEC sp_AddSP N'Túi trắng',40,'L',970000,'88.jpn',N'Việt Nam','LSP18'
EXEC sp_AddSP N'Túi hồng',40,'XL',770000,'89.jpn',N'Trung Quốc','LSP18'
EXEC sp_AddSP N'Túi đen',40,'L',850000,'90.jpn',N'Việt Nam','LSP18'

--đồng hồ
EXEC sp_AddSP N'Đồng hồ 1',40,'M',570000,'91.jpn',N'Việt Nam','LSP19'
EXEC sp_AddSP N'Đồng hồ 2',40,'L',670000,'92.jpn',N'Mỹ','LSP19'
EXEC sp_AddSP N'Đồng hồ 3',40,'XL',760000,'93.jpn',N'Việt Nam','LSP19'
EXEC sp_AddSP N'Đồng hồ 4',40,'S',470000,'94.jpn',N'Trung Quốc','LSP19'
EXEC sp_AddSP N'Đồng hồ 5',40,'L',870000,'95.jpn',N'Hàn Quốc','LSP19'

--Giày
EXEC sp_AddSP N'Giày cao gót 1',40,'L',1230000,'96.jpn',N'Mỹ','LSP19'
EXEC sp_AddSP N'Giày búp bê',40,'XL',2040000,'97.jpn',N'Việt Nam','LSP19'
EXEC sp_AddSP N'Giày cao gót 2',40,'M',5600000,'98.jpn',N'Trung Quốc','LSP19'
EXEC sp_AddSP N'Giày cao gót 3',40,'XL',6420000,'99.jpn',N'Việt Nam','LSP19'
EXEC sp_AddSP N'Giày sneaker',40,'S',2530000,'100.jpn',N'Trung Quốc','LSP19'
